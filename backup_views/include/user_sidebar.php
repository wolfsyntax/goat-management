  ...
  <div class="sidebar bg-light" id="sidebar-div" style="margin-top: 10px !important;">
    <ul class="nav flex-column " id="sidebar">
      ...
      <li class="nav-item ">
        ...
        <a class="nav-link text-dark sb-menu" href="activity/checkup/view" aria-expanded="false" aria-controls="healthCheck" data-toggled="popover" title="Health Check" data-content="Here you can farm activities like Vaccination, Supplementation and Health Checkup" data-placement="right" >
           <span class="fa fa-heartbeat text-success d-inline d-sm-inline-block d-md-inline-block d-lg-none" title="Health Check"></span>
      ...
      <li class="nav-item">
        <a class="nav-link text-dark sb-menu" href="<?= base_url('inventory/view') ?>" data-toggle="collapse" aria-expanded="false" aria-controls="breedingInfo" data-toggled="popover" title="Asset Management" data-content="Here you can manage your farm assets" id="amgmt">
