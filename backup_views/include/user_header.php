  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropright dropdown-x" href="<?= base_url() ?>dashboard" title="Settings" style="position: relative; top: 3px;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="navDrop"> <i class="fa fa-cog" ></i><span class="d-block-inline d-sm-block-inline d-md-block-inline d-lg-none ">&emsp;Settings</span></a>
        <div class="arrow"></div>
